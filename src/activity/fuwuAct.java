...
public class fuwuAct extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		textView.setText("欢迎您使用共享交友软件及服务！"+"\n"+"     为使用本软件及服务，您应当阅读并遵守该协议。"+
		        ...
		        "     （5）通过修改或伪造软件运行中的指令、数据，增加、删减、变动软件的功能或运行效果，或者将用于上述用途的软件、方法进行运营或向公众传播，无论这些行为是否为商业目的；"+"\n"+"     （6）通过非本开发者开发、授权的第三方软件、插件、外挂、系统，登录或使用本开发者软件及服务，或制作、发布、传播上述工具；"+"\n"+
		        ...
		        "     （10）若您违反前述约定、本协议或相关法规政策，开发者有权不经您同意而直接解除您的好友关系；若您的单向或双向好友(简称“违规用户”)违反前述约定、本协议或相关法规政策，开发者有权按照本协议、相关协议或相关法规政策等，对违规用户进行处理，由此可能影响您与违规用户之间的信息交流、好友关系等以及您对本服务的使用，同时您知悉：这是开发者为了维护健康良好的网络环境而采取的必要措施，若由于开发者按照前述约定对违规用户采取措施而对您产生影响或任何损失的，您同意不追究开发者的任何责任或不向开发者主张任何权利。"+"\n"+
				"     （11）通过本服务向好友或其他用户发送大量信息；"+"\n"+"     （12）其他未经开发者明示授权、许可或违反本协议及相关协议、规则的行为。"+"\n"+"7.3对自己的行为负责"+"\n"+"     您充分了解并同意，您必须为自己注册帐号下的一切行为负责，包括您所发表的任何内容以及由此产生的任何后果。您应对使用本服务时接触到的内容自行加以判断，并承担因使用内容而引起的所有风险，包括因对内容的正确性、完整性或实用性的依赖而产生的风险。开发者无法且不会对您因前述风险而导致的任何损失或损害承担责任。"+"\n"+
